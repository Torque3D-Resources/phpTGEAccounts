...
*/
// ADOdb Configuration
define('ADODB_DIR', './adodb/'); // Change "adodb" to the directory that was taken from the ADOdb zip file you downloaded. Remember, *nix systems are cAsE-SeNsItIvE
...
define('SMARTY_DIR', './Smarty-2.6.9/libs/'); // Change "Smarty-2.6.9" to the correct directory from what you downloaded. Remember, *nix systems are cAsE-SeNsItIvE
...
$ADODB_FETCH_MODE = ADODB_FETCH_ASSOC; // Forces ADOdb to use associative arrays ($blah['blah blah'])
?>